...
void Menu(vector<CTimeSpan*> list) {
    ...
    {
        system("cls");
        cout << "1. THEM THOI GIAN (Input)\n";
        cout << "2. XUAT THOI GIAN (Output)\n";
        cout << "3. TINH TOAN (+, -, ++, --)\n";
            ...
            if (list.size() >= 2) {
                ...
                while (true)
                {
                    ...
                    if (lc1 == '0') break;
                        ...
                        else cout << "KET QUA: " << *list.at(x) - *list.at(y) << endl;
                    }
                    else if (lc1 == '3') {
                        *list.at(x)++;
                        *list.at(y)++;
                        cout << "SAU KHI TANG 1s\n";
                        cout << "THOI GIAN 1: " << *list.at(x)<< endl;
                        cout << "THOI GIAN 2: " << *list.at(y)<< endl;
                    }
                    else if (lc1 == '4') {
                        *list.at(x)--;
                        *list.at(y)--;
                        cout << "SAU KHI GIAM 1s\n";
                        cout << "THOI GIAN 1: " << *list.at(x)<< endl;
                        cout << "THOI GIAN 2: " << *list.at(y)<< endl;
                    }
